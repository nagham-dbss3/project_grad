...
export const ar = {
  ...
  profile: {
    ...
    changePasswordHint: 'استخدم كلمة سر جديدة لا يعرفها غيرك.',
    ...
    newRequired: 'يرجى إدخال كلمة السر الجديدة.',
    confirmRequired: 'يرجى تأكيد كلمة السر الجديدة.',
    mismatch: 'كلمة السر الجديدة وتأكيدها غير متطابقتين.',
    passwordShort: 'كلمة السر الجديدة يجب أن تكون 8 أحرف على الأقل.',
    passwordWeak: 'كلمة السر ضعيفة. استخدمي أحرفاً وأرقاماً معاً.',
    currentWrong: 'كلمة السر الحالية غير صحيحة.',
    changeSuccess: 'تم تغيير كلمة السر بنجاح.',
    changeFailed: 'تعذّر تغيير كلمة السر. حاول مرة أخرى.',
